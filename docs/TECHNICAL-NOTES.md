...
Shared release folders should include the app build number in the folder name, using this format: `CFIDataClean-v1.0.02`. The folder version should match `$script:AppVersion` in `_CFIDataClean_AppFiles\ForestInventoryCleaner.ps1`.
